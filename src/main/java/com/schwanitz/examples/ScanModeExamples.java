...
//        List<TagInfo> tags = TagFormatDetector.comfortScan(filePath);
//
...
//
//        List<TagInfo> tags = TagFormatDetector.fullScan(filePath);
//
...
//        List<TagInfo> id3Tags = TagFormatDetector.customScan(filePath, TagFormat.ID3V2_3, TagFormat.ID3V2_4, TagFormat.ID3V1, TagFormat.ID3V1_1);
...
//        Map<String, List<TagInfo>> results = TagFormatDetector.comfortScan(filePaths);
//
...
//            }
//
//            List<TagInfo> tags = TagFormatDetector.customScan(filePath, TagFormat.ID3V2_4, TagFormat.ID3V2_3, TagFormat.VORBIS_COMMENT, TagFormat.MP4);
